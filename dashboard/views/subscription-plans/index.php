...
<div class="container container--fixed">
            ...
            <div class="col-sm-auto">
                <div class="buttons-group d-flex align-items-center">
                    ...
                    <?php if ($siteUserType == User::LEARNER) { ?>
                        <label class="btn btn--bordered color-secondary ml-3 btn--checkbox  margin-left-4">
                            <input type="checkbox" name="user_autorenew_subscription" value="1" <?php echo ($autoRenew == 1) ? 'checked="checked"' : ''; ?> onclick="autoRenew(this.checked)" />
                            <?php echo Label::getLabel('LBL_AUTO_RENEW'); ?>
                        </label>
                    <?php } ?>
                </div>
            </div>
    ...
    <script>
        var frontendUrl = '<?php echo CONF_WEBROOT_FRONTEND; ?>';
    </script>