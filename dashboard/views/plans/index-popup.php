...
<div class="modal-header gap-2">
    <h5 class="flex-1"><?php echo Label::getLabel('LBL_Attach_Lessons_Plans'); ?></h5>
    <div class="buttons-group d-flex align-items-center">
        <a href="javascript:void(0)" class="btn btn--secondary btn--block-mobile slide-toggle-js">
...
<div class="modal-body">
    <div id="plan-search" class="slide-target-js mb-4" style="display: none;">
    ...
    <div class="plan-listing plan-listing-facebox" id="listing"></div>
</div>
