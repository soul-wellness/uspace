...
$(document).ready(function () {
    ...
    $(document).on('click', '.openAlertJs', function () {
        if ($(".mainHeaderJs").find(".closeAlertJs").length == 0) {
            ...
            fcom.updateWithAjax(
                fcom.makeUrl("PageLangData", "displayAlert"),
                data,
                function (t) {
    ...
    /* for common tabs */
    $(".tabs_panel").hide();
    $('.tabs-wrap').find(".tabs_panel:first").show();
    /* if in tab mode */
    $(".tabs-nav li a").click(function () {
        ...
        //$(this).parents('.tabs-container:first').find(".tabs_panel").hide();
        $("#" + activeTab).fadeIn();
        $(this).parents('.tabs-container:first').find(".tabs-nav li a").removeClass("active");
        $(this).addClass("active");
    ...
    $(".togglehead").click(function () {
        $(this).parents('.tabs-wrap:first').find(".tabs_panel").hide();
        var d_activeTab = $(this).attr("rel");
        $(window).scrollTop($(this).parents('.tabs-wrap:first').offset().top - 50);
        if ($(this).hasClass("active")) {
            $(".togglehead").removeClass("active");
            $(this).parents('.tabs-container:first').find(".tabs-nav li a").removeClass("active");
            return false;
        ...
        $(this).addClass("active");
        $(this).parents('.tabs-container:first').find(".tabs-nav li a").removeClass("active");
        $(".tabs-nav li a[rel^='" + d_activeTab + "']").addClass("active");
        if ($(this).attr('data-chart')) {
            if (layoutDirection != 'rtl') {
                $position = 'start';
            } else {
    ...
    $(document).delegate('.js--filter-trigger', 'click', function () {
        $(this).toggleClass("active");
